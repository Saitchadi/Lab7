...
public class RPSLSpock {
    ...
    /**
     * @author Salah Ait Chadi
     * @param pick is the user's choice
     * @return false if the user's answer is null otherwise returns his choice
     */
     ...
     * @return the computer choice and the winner
     */
